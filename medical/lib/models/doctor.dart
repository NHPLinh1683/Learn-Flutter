...
class DoctorModel {
  ...
  static List<DoctorModel> getDoctors() {
    ...
    doctors.add(DoctorModel(
        ...
        time: [
          TimeModel(time: '9:00 AM', isSelected: false),
          TimeModel(time: '11:00 AM', isSelected: false),
          TimeModel(time: '3:00 PM', isSelected: false),
        ]
    ));
    ...
    doctors.add(DoctorModel(
        ...
        score: 4.8,
        bio:
            "Dr. Kristin Watson (Palaeontologist),  is a Dentist in America, she has 20 years of experience.",
        calendar: [
          CalendarModel(dayNumber: 14, dayName: "Sun", isSelected: false),
          CalendarModel(dayNumber: 15, dayName: "Mon", isSelected: false),
          CalendarModel(dayNumber: 16, dayName: "Tue", isSelected: false),
